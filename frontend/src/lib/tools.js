 ...
 */
export function generateMartindaleURL(functionParams, returnParams = false) {
...
export function generateJustiaURL(
  desiredCity,
...
export const justiaToolDescription = {
  type: "function",
  function: {
